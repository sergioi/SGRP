...
<div class="panel-heading" style="color:gree">
  ...
  <tbody>
    <?php
    $directorio = "Anexo_I/Administracion";
                            ...
                            <tr>
                              ...
                              <td>
                                  <a title="Descargar Archivo"
                                    href="Anexo_I/Administracion/<?php echo $archivos[$i]; ?>" 
...
<div class="panel-heading" style="color:gree">
  ...
  <tbody>
    <?php
    $directorio = "Anexo_V/Administracion";
    $archivos   = scandir($directorio);
                    ...
                    ?>
                          <p>  
                            ...
                            <tr>
                              ...
                              <td>
                                  <a title="Descargar Archivo"
                                    href="Anexo_V/Administracion/<?php echo $archivos[$i]; ?>" 
                                    download="<?php echo $archivos[$i]; ?>"
                                    style="color: black; font-size:18px;">
                                    <i class='fas fa-cloud-download-alt'></i>
                                  </a>
