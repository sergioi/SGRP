...
class PermisosHelpers
{
    ...
    public static function activaEtapa1($estado_nombre)
    {
        return ValorHelpers::activarlaEtapa1($estado_nombre);
    }

    public static function activaEtapa2($estado_nombre)
    {
        return ValorHelpers::activarlaEtapa2($estado_nombre);
    }

    public static function activaEtapa3($estado_nombre)
    {
        return ValorHelpers::activarlaEtapa3($estado_nombre);
    }
    
    public static function activaEtapa4($estado_nombre)
    {
        return ValorHelpers::activarlaEtapa4($estado_nombre);
    }
